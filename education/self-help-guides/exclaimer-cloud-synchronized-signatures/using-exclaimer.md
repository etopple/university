...
1. To add a signature to your email, click the Exclaimer icon <img src="../../../.gitbook/assets/image (113).png" alt="" data-size="line">. It could be in the bottom toolbar, menu ribbon, or within the ellipsis menus.&#x20;
...
3. From the signature pane, select the signature required. The default signature for new messageswill have a Pencil, and the default signature for replies/forwards will have an arrow.\
   ![A signature block with the default icons highlighted](<../../../.gitbook/assets/image (114).png>)
