...
1. Launch the Sophos Connect software from the start menu/the desktop/or the task bar (near the time, at the bottom right-hand corner by default You might need to click the arrow to show all applications.)\
   ![](<../../../../.gitbook/assets/image (3) (1) (1) (1) (1) (1).png>) ![](<../../../../.gitbook/assets/image (1) (1).png>)
...
1. If Sophos Connect has connected, it will show a green dot in the taskbar icon  ![](<../../../../.gitbook/assets/image (1) (1) (1).png>) and a green check mark in the application (with the option to Disconnect)\
   ![](<../../../../.gitbook/assets/image (2) (1).png>)
2. If Sophos Connect is disconnected or failed to connect, it will show a red dot in the taskbar icon ![](<../../../../.gitbook/assets/image (3) (1).png>) and the option to Connect in the application. \
