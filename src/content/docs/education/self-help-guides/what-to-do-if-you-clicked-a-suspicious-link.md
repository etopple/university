...
* **Do not turn off your computer** — IT may need to investigate what happened.
...
1. On a **different, trusted device** (like your phone), go to [https://mysignins.microsoft.com/security-info](https://mysignins.microsoft.com/security-info).
...
You can also **report the email** directly in Outlook by selecting the message and clicking **Report → Report phishing** in the toolbar.
...
|---|---|---|
| Clicked a link but didn't enter anything | Low | Report it, monitor your account |
| Clicked a link and entered your password | High | Change password immediately + contact eTop |
| Entered password AND MFA code | Critical | Contact eTop immediately — attacker may have access |
...
[Report Messages to Microsoft](office-365-guides/outlook/report-messages-to-microsoft.md)
