...
> **Important:** Use **Restart**, not **Shut Down**. In Windows 10/11, "Shut Down" uses Fast Startup which doesn't fully reset your system. Click **Start** → **Power** → **Restart**.
...
2. Click **"More details"** if needed to see the full view.
3. Click the **CPU** column to sort by processor usage, then check **Memory** and **Disk**.
4. Look for any application using an unusually high percentage (above 80-90%).

**Common culprits:**
* **Browser with many tabs** — Each tab uses memory. Close tabs you're not actively using.
* **Outlook** — Large mailboxes can slow things down. See our [Outlook Performance Guide](office-365-guides/outlook/outlook-running-slow-or-search-not-working.md).
* **Windows Update** — Updates running in the background can temporarily slow your computer. Let them finish.
* **Antivirus scan** — Scheduled scans may run during work hours. Let the scan complete if possible.
...
3. Check your **C: drive** — if it shows red or has less than **10 GB free**, that's likely contributing to the problem.

**Quick ways to free space:**
* Empty your **Recycle Bin** (right-click it on the desktop → Empty Recycle Bin).
* Clear your **Downloads folder** — move files you need to OneDrive and delete the rest.
...
* Make sure **vents are not blocked** — don't use your laptop on soft surfaces like beds or pillows.
...
* **Dust buildup** in vents can cause overheating over time — a can of compressed air can help.
...
* Try opening [https://fast.com](https://fast.com) to check your internet speed.
