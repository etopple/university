...
* **Writing an email:** Click Copilot → **"Draft with Copilot"** to generate a response. You can give it instructions like "Reply professionally and accept the meeting request."
...
## I Don't See Copilot — What Do I Do?

If Copilot isn't showing up in your apps:

1. **Check your license:** Copilot requires a specific Microsoft 365 Copilot license. Not all users may have it enabled yet — check with your manager.
2. **Update your apps:** Make sure your Microsoft 365 apps are up to date. Go to any Office app → **File** → **Account** → **Update Options** → **Update Now**.
...
If you've checked all of the above and still don't see it, contact eTop — we can verify your license status.
...
* Copilot **respects permissions** — it can only surface information you already have access to.
